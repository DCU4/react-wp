...
class Locations extends Component {
  ...
  getPosts = async () => {
    ...
    const url = 'https://updates-fishtaco.pantheonsite.io/wp-json/custom-api/v1/all-locations/';
    // const url = 'https://fishtaco.lndo.site/wp-json/custom-api/v1/all-locations/';
